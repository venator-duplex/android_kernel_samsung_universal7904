...
#define GET_SULOG_DUMP_V2 10010U
#define CHANGE_KSUVER 10011U
#define CHANGE_SPOOF_UNAME 10012U

struct ksu_become_daemon_cmd {
    __u8 token[65]; /* Input: daemon token (null-terminated) */
};

#define EVENT_POST_FS_DATA 1U
#define EVENT_BOOT_COMPLETED 2U
#define EVENT_MODULE_MOUNTED 3U
...
#define KSU_UMOUNT_WIPE 0U /* ignore everything and wipe list */
#define KSU_UMOUNT_ADD 1U /* add entry (path + flags) */
#define KSU_UMOUNT_DEL 2U /* delete entry, strcmp */
