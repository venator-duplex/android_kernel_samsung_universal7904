			   ...
			   struct cftype *cft)
{
	...
	/*
	 * Android commonly mounts legacy cgroup hierarchies with "noprefix".
	 * Keep the unprefixed names expected by Android, but also expose the
	 * controller-prefixed aliases expected by LXC/Droidspaces userspace.
	 */
